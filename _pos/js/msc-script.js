...
function Popup(data) {
    ...
    mywindow.document.write('<head><link href="../css/style.css" rel="stylesheet"><link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro" rel="stylesheet"></head>');
    ...
    mywindow.document.write('<script type="text/javascript" src="../js/jquery-3.2.0.min.js"></script>'); 
